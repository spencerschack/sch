 ...
 */
async function getClaudeProjectPath(worktreeName) {
 ...
 */
async function getCursorAgentStatus(worktreeName) {
 ...
 */
async function getClaudeAgentStatus(worktreeName) {
 ...
 */
export async function getAgentStatus(worktreeName) {
